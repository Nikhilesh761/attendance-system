...
class CameraState:
    ...
    def _open_capture(self):
        ...
        # RTSP is much more reliable over TCP for this phone/IP-camera stream.
        try:
            params = []
            if hasattr(cv2, "CAP_PROP_OPEN_TIMEOUT_MSEC"):
                params += [cv2.CAP_PROP_OPEN_TIMEOUT_MSEC, 10000]
            ...
            pass
        # Final fallback to OpenCV's normal backend.
        try:
